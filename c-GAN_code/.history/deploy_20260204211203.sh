...
# Setup configuration variables
environment_path= "./containers/fl_env_v5.sif"
NUM_GPUS=${SLURM_GPUS_ON_NODE:-0}
CONFIG_FILE="./c-GAN_code/configs/base_modified.yaml"
FEDN_COMMAND="python client/client_runner.py --num-gpus ${NUM_GPUS} --config-file ${CONFIG_FILE}"
