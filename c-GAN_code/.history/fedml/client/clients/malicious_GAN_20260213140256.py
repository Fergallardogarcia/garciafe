...
class GanMaliciousClient(HonestClient):
    ...
    def generate_D_syn(self, generator_model: torch.Tensor, server_round: int, trainset: Dataset) -> Dataset:
        """Generate synthetic data fro client according to train distribution
