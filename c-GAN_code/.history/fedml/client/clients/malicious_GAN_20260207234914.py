...
from fedml.defenses.filters.gan_MAL import MaliciousGenerator as MalGen #Added

class GanAttackClient(HonestClient):
    ...
    def __init__(
        ...
        self.scale_factor = self.attack_config["GAN_ATTACK_CONFIG"]["SCALE_FACTOR"]
