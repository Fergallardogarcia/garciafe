...
class GanMaliciousClient(HonestClient):
    ...
    def combined_loss(self, gen_loss: torch.Tensor, local_loss: torch.Tensor, combine_config: Optional[Dict]) -> torch.Tensor:
        ...
        """
        criterion_good= g_loss = criterion(dis_predict, input_l).to(device)
        return
