...
class GanMaliciousClient(HonestClient):
    ...
    def __init__(
        ...
        filter_param = self.attack_config["SERVER_CONFIGS"]["FILTER_CONFIGS"]["HYPER_PARAM"]
        ...
        self.malicious_generator = MalGen(gen_configs, dis_configs, train_configs, filter_configs, skip_rounds = 1)
