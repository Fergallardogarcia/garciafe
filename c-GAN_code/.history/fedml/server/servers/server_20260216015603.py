...
class Server:
    def __init__(
        ...
        *, 
        ...
        self.attack = create_filter(user_configs=user_configs, mode="ATTACK")
    ...
    def fit_round(self, server_round: int):
        ...
        self.attack.server_task_fit_round_before(
            global_parameters=self.parameters,
            server_round=server_round,
            executor=self.executor,
            client_manager=self.client_manager,
        ...
        if self.filter.server_fit_round_after() is not None None:
        ...
        metrics_aggregated = log_filter_stats(self, metrics_aggregated, client_stats, results)
