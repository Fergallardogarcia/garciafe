...
class Server:
    ...
    def server_tasks(self, user_configs): # MINE
        """Perform any server side tasks that can run in parallel to client training. Useful to perform GAN training in parallel to client training."""
        pass
