...
class Server:
    def __init__(
        ...
        *, 
        ...
        self.filters = create_filter(user_configs=user_configs, mode="DEFENSE") #Create both filters with this
        # modify to return defense and attack filters separately
    ...
    def deliver_generator_updates(self, client_instructions, submitted_fs):
        for client, model, device, ins in client_instructions:
            if client.client_type == "GAN_ATTACK":
                client.malicious_generator=self.filters["GAN_ATTACK"]
